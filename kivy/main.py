...
"""
Interactive linux app in python with Qt. The app will take a directory as a command line parameter. It will scan the directory recursively for jpeg files that contain location and orientation information ('GPS GPSImgDirection') in metadata. It will index all these files in an in-memory list.
